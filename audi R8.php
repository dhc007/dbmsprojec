            ...
            <div class="single">
                            ...
                            <div id="products_example">
                                <div id="products">
                                    <div class="slides_container">
                                        <a href="#" target="_blank"><img src="images/r8_1.jpg" alt=" " height=210px
                                                width=560px /></a>
                                        <a href="#" target="_blank"><img src="images/r8_2.jpg" alt=" " height=210px
                                                width=560px /></a>
                                        <a href="#" target="_blank"><img src="images/r8-3.jpg" alt=" " height=210px
                                                width=560px /></a>
                                        <a href="#" target="_blank"><img src="images/r8-4.jpg" alt=" " height=210px
                                                width=560px /></a>
                ...
                <table class="table table-bordered table-responsive table-striped table-hover table-condensed">
                    ...
                    <tbody>
                        <tr>
                            <td>
                                German carmaker launched New Audi R8 at the Auto Expo 2016. The model was first
                                introduced at the 2015 Geneva Motor Show. New elements include a digital 12.3-inch Audi
                                Virtual cockpit system with customisation options on the screen. Overall designing and
                                the dimensions remain identical to its predecessor. The vehicle is powered by a 5.2L V10
                                motor with two engine specifications, delivering 610bhp and 540bhp of output separately.
                                Audi R8 has a top speed of 330kmph and it breaks the 0-100kmph mark in just 3.2 seconds.
                                Using a 7-speed S-Tronic gearbox, the engine sends power to all the four wheels via
                                Quattro AWD system. Audi R8 shares 50% of its parts with R8 LMS and competes with the
                                likes of Mercedes-AMG GT, McLaren 570S and Porsche 911.
                            </td>
                        </tr>
                    </tbody>
                </table>
