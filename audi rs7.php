            ...
            <div class="single">
                            ...
                            <div id="products_example">
                                <div id="products">
                                    <div class="slides_container">
                                        <a href="#" target="_blank"><img src="images/rs7-1.jpg" alt=" " height=210px
                                                width=560px /></a>
                                        <a href="#" target="_blank"><img src="images/rs7-2.jpg" alt=" " height=210px
                                                width=560px /></a>
                                        <a href="#" target="_blank"><img src="images/rs7-3.jpg" alt=" " height=210px
                                                width=560px /></a>
                                        <a href="#" target="_blank"><img src="images/rs7-4.jpg" alt=" " height=210px
                                                width=560px /></a>
                ...
                <table class="table table-bordered table-responsive table-striped table-hover table-condensed">
                    ...
                    <tbody>
                        <tr>
                            <td>
                                The RS 7 performance sportback features a bi-turbo 4.0-litre V8 that has been tweaked to
                                produce 560PS and 700Nm of torque. The engine comes mated to an eight-speed automatic
                                gearbox. The car is one of the most powerful models in Audi's range and has a 0-100kmph
                                time of just 3.9 seconds. If blistering performance isn’t enough, Audi has just launched
                                the RS 7 ‘Performance’! The sportback uses the same 4.0-litre TFSI bi-turbo V8 engine as
                                the standard RS 7, but bumps the power output up from 560PS to 605PS, while the torque
                                output goes up by a full 50Nm to 750Nm through the ‘Overboost’ torque-on-demand
                                function. The result? While the standard RS 7 does the 0-100kmph sprint in 3.9 seconds,
                                the Performance pack shaves it down to 3.7 seconds. Even the top speed isn’t limited to
                                250kmph and goes up to 305kmph.
                            </td>
                        </tr>
                    </tbody>
                </table>
