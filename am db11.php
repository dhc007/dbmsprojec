            ...
            <div class="single">
                            ...
                            <div id="products_example">
                                <div id="products">
                                    <div class="slides_container">
                                        <a href="#" target="_blank"><img src="images/db-1.jpeg" alt=" " height=210px
                                                width=560px /></a>
                                        <a href="#" target="_blank"><img src="images/db-2.jpg" alt=" " height=210px
                                                width=560px /></a>
                                        <a href="#" target="_blank"><img src="images/db-3.jpg" alt=" " height=210px
                                                width=560px /></a>
                                        <a href="#" target="_blank"><img src="images/db-4.jpg" alt=" " height=210px
                                                width=560px /></a>
                ...
                <table class="table table-bordered table-responsive table-striped table-hover table-condensed">
                    ...
                    <tbody>
                        <tr>
                            <td>
                                Aston Martin has launched the DB11 super car in India. Priced at Rs 3.97 crore
                                (ex-showroom, Delhi), the DB11 will rival the Italian Ferrari 458 Speciale in the Indian
                                market. It comes with a 5.2-litre twin-turbo V12 engine, which has been developed
                                in-house by Aston Martin. This V12 produces 616PS of power and 700Nm of torque.
                                Performing the power transmission duties is an eight-speed automatic ZF transmission
                                with multiple driver dynamic modes – GT, Sport and Sport Plus. Also, the DB11 has a
                                limited slip differential with active torque vectoring, a first in the DB family. All of
                                the above components come together to propel the DB11 from 0-100kmph in just 3.9 seconds
                                and all the way to a top speed of 322kmph. Inside, the DB11 has a simple dual-tone
                                layout and a clutter-free centre console. It has a twelve-inch TFT LCD display in the
                                all-new instrument cluster and an eight-inch TFT screen in the centre of the dashboard
                                for infotainment.
                            </td>
                        </tr>
                    </tbody>
