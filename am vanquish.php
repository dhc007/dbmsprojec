            ...
            <div class="single">
                            ...
                            <div id="products_example">
                                <div id="products">
                                    <div class="slides_container">
                                        <a href="#" target="_blank"><img src="images/v-1.jpg" alt=" " height=210px
                                                width=560px /></a>
                                        <a href="#" target="_blank"><img src="images/v-2.jpg" alt=" " height=210px
                                                width=560px /></a>
                                        <a href="#" target="_blank"><img src="images/v-3.jpg" alt=" " height=210px
                                                width=560px /></a>
                                        <a href="#" target="_blank"><img src="images/v-4.jpg" alt=" " height=210px
                                                width=560px /></a>
                ...
                <table class="table table-bordered table-responsive table-striped table-hover table-condensed">
                    ...
                    <tbody>
                        <tr>
                            <td>
                                With the name that needs no introduction in automobile industry, Aston Martin has come
                                up with all new Vanquish V12. This high profile British company has just introduced the
                                most expensive Aston Martin in India. Let it be the engine, transmission, comfort,
                                safety features it’s almost an impossible task to find any fault in Aston Martin
                                Vanquish V12. The car flies from 0 to 100kmph in just 4.1 seconds and that says
                                everything about the engine and transmission. Vanquish is a D+ segment car that has
                                interiors and exteriors to die for and is a successor of Aston Martin DBS. Under the
                                hood this high class car has a 6 litre V 12 engine which will take anyone’s breath away
                                with 295kmph top speed . This car is a powerhouse of features that Indians might not
                                even have the tiny bit of a clue.
                            </td>
                        </tr>
                    </tbody>
                </table>
