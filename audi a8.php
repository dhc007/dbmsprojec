            ...
            <div class="single">
                            ...
                            <div id="products_example">
                                <div id="products">
                                    <div class="slides_container">
                                        <a href="#" target="_blank"><img src="images/a8-1.jpg" alt=" " height=210px
                                                width=560px /></a>
                                        <a href="#" target="_blank"><img src="images/a8-2.jpg" alt=" " height=210px
                                                width=560px /></a>
                                        <a href="#" target="_blank"><img src="images/a8-3.jpg" alt=" " height=210px
                                                width=560px /></a>
                                        <a href="#" target="_blank"><img src="images/a8-4.jpg" alt=" " height=210px
                                                width=560px /></a>
                ...
                <table class="table table-bordered table-responsive table-striped table-hover table-condensed">
                    ...
                    <tbody>
                        <tr>
                            <td>
                                The next generation of Audi's flagship sedan, the A8 was spotted testing in May 2016.
                                The luxo-barge borrows heavily from the Prologue concept that was showcased at the 2016
                                Delhi Auto Expo. The camouflaged prototype showed off the reworked face, crisp character
                                lines and the new rear section with LED tail-lamps. The A8 goes up against the likes of
