            ...
            <div class="single">
                            ...
                            <div id="products_example">
                                <div id="products">
                                    <div class="slides_container">
                                        <a href="#" target="_blank"><img src="images/r-1.jpg" alt=" " height=210px
                                                width=560px /></a>
                                        <a href="#" target="_blank"><img src="images/r-2.jpg" alt=" " height=210px
                                                width=560px /></a>
                                        <a href="#" target="_blank"><img src="images/r-3.jpg" alt=" " height=210px
                                                width=560px /></a>
                                        <a href="#" target="_blank"><img src="images/r-4.jpg" alt=" " height=210px
                                                width=560px /></a>
                ...
                <table class="table table-bordered table-responsive table-striped table-hover table-condensed">
                    ...
                    <tbody>
                        <tr>
                            <td>
                                British luxury sportscar maker - Aston Martin has introduced the 2016 Rapid in India.
                                Priced at INR 3.29 crore (ex-showroom, Thane), the four-door sports saloon will be
                                retailed through Mumbai-based Performance Cars. It gets a new front-end, a revised
                                engine, a reinforced body, a reappraised chassis and a refreshed cabin as well. Powering
                                the newest Aston in town is a mighty 517bhp, 6.0-litre V12 engine that’s coupled with a
                                ZF-sourced 8-speed automatic gearbox, which enables the Rapide to sprint 0-100kph in
                                mere 4.6 seconds and achieving a top speed of 306kph. If compared to the predecessor,
                                this new Rapide has 17 per cent more power and 10 per cent more torque.
                            </td>
                        </tr>
                    </tbody>
                </table>
