        ...
        <div class="wrap">
            <div class="single">
                <div class="box_wrapper">
                    <h1>Kawasaki ZX10R : (Rs 29.45 L*)</h1>
                </div>
                            ...
                            <div id="products_example">
                                <div id="products">
                                    <div class="slides_container">
                                        <a href="#" target="_blank"><img src="images/zx10r.jpeg" alt=" " height=210px
                                                width=560px /></a>
                                        <a href="#" target="_blank"><img src="images/zx10r1.jpeg" alt=" " height=210px
                                                width=560px /></a>
                                        <a href="#" target="_blank"><img src="images/zx10r2.jpeg" alt=" " height=210px
                                                width=560px /></a>
                    ...
                    <tbody>
                        <tr>
                            <td>
                                ...
                                The Kawasaki ZX-10R is a high-performance superbike designed for adrenaline-seeking
                                riders who crave speed and precision. With a 998cc inline-four engine at its core, the
                                ZX-10R delivers exhilarating power and acceleration, making it a formidable force on
                                both the road and the racetrack. The bike's aerodynamic design, including its aggressive
                                fairings and sleek lines, enhances its stability and allows for maximum efficiency at
                                high speeds. Advanced electronics, such as multiple riding modes, traction control, and
                                quick-shifter, ensure optimal control and safety in various riding conditions. The
                                ZX-10R's responsive handling, aided by its robust chassis and high-performance
                                suspension, allows riders to carve corners with confidence and precision. As a result,
                                the Kawasaki ZX-10R stands as a flagship superbike, embodying the thrill and performance
                                that make it a favorite among speed enthusiasts and professional racers alike.
                            </td>
                        </tr>
                    </tbody>
                </table>
