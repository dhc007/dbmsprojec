                            ...
                            <div id="products_example">
                                <div id="products">
                                    <div class="slides_container">
                                        <a href="#" target="_blank"><img src="images/t-1.jpg" alt=" " height=210px
                                                width=560px /></a>
                                        <a href="#" target="_blank"><img src="images/t-2.jpg" alt=" " height=210px
                                                width=560px /></a>
                                        <a href="#" target="_blank"><img src="images/t-3.jpg" alt=" " height=210px
                                                width=560px /></a>
                                        <a href="#" target="_blank"><img src="images/t-4.jpg" alt=" " height=210px
                                                width=560px /></a>
                    ...
                    <tbody>
                        <tr>
                            <td>
                                ...
                                Chevrolet has launched the Trailblazer to compete with the Toyota Fortuner and the Ford
                                Endeavour. The body-on-frame Trailblazer has replaced the monocoque Chevrolet Captiva in
                                GM India's line-up. The SUV made its way to India via a CBU (Completely Built Up) route
                                and is only offered in a single variant (LTZ) in a 2WD (two wheel drive) setup. Powering
                                the Trailblazer is Chevrolet's 2.8-litre DuraMax diesel engine mated to a six-speed
                                automatic transmission. The oil burner musters class-leading 200PS of peak power and max
                                torque of 500Nm. Chevrolet India has started testing the updated 2017 Trailblazer in the
                                country. The car was recently spied in the NCR region. It is expected to come early next
                                year with more variants and a 4WD (four wheel drive) option, while mechanically it will
                                remain unaltered. In order to give the current Trailblazer a sales boost, Chevrolet has
                                slashed the SUV's price by Rs 3.04 lakh and it now retails for Rs 23.95 lakh,
                                ex-showroom, Delhi.
                            </td>
                        </tr>
                    </tbody>
