            ...
            <div class="single">
                            ...
                            <div id="products_example">
                                <div id="products">
                                    <div class="slides_container">
                                        <a href="#" target="_blank"><img src="images/va-1.jpg" alt=" " height=210px
                                                width=560px /></a>
                                        <a href="#" target="_blank"><img src="images/va-2.jpg" alt=" " height=210px
                                                width=560px /></a>
                                        <a href="#" target="_blank"><img src="images/va-3.jpg" alt=" " height=210px
                                                width=560px /></a>
                                        <a href="#" target="_blank"><img src="images/va-4.jpg" alt=" " height=210px
                                                width=560px /></a>
                ...
                <table class="table table-bordered table-responsive table-striped table-hover table-condensed">
                    ...
                    <tbody>
                        <tr>
                            <td>
                                Aston Martin V12 Vantage S has been voted as the 'most elegant car of 2014' by viewers
                                of popular French automotive TV show Automoto TF1. This sports car is the company's
                                fastest series production car to date and features carbon fibre grille, new roof and
                                rear graphics packs, lightweight forged alloy wheels, bespoke finishes on seats, doors
                                and control . It is powered by the same AM28 6-litre V12 engine that powers its entry
                                level version model but in a more powerful tune. This car produces 11% more than its
                                regular version with 573 PS, 9% more torque with 620 Nm and is 14% much faster with 0-60
                                mph time of 3.7 seconds. While the top speed for this model is pegged at 305 km/h, this
                                sports car gets a top speed of 328 km/h.
                            </td>
                        </tr>
                    </tbody>
                </table>
